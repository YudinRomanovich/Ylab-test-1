...
@pytest.mark.asyncio(scope='session')
async def test_get_submenus_first(ac: AsyncClient) -> None:
...
@pytest.mark.asyncio(scope='session')
async def test_get_submenus_second(ac: AsyncClient) -> None:
...
@pytest.mark.asyncio(scope='session')
async def test_get_specific_submenu_first(ac: AsyncClient) -> None:
...
@pytest.mark.asyncio(scope='session')
async def test_update_submenu(ac: AsyncClient, submenu_patch: dict[str, str]) -> None:
...
@pytest.mark.asyncio(scope='session')
async def test_get_specific_submenu_second(ac: AsyncClient) -> None:
...
@pytest.mark.asyncio(scope='session')
async def test_get_submenus_third(ac: AsyncClient) -> None:
